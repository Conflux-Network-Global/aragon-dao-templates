...
const deployAPM = require('@conflux-/aragon-os/scripts/deploy-apm')
const deployENS = require('@conflux-/aragon-os/scripts/deploy-test-ens')
const deployAragonID = require('@conflux-/aragon-id/scripts/deploy-beta-aragonid')
const deployDAOFactory = require('@conflux-/aragon-os/scripts/deploy-daofactory')
